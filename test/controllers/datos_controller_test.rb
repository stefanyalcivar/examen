...
class DatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dato" do
    assert_difference('Dato.count') do
      post datos_url, params: { dato: { apellidos: @dato.apellidos, cargo: @dato.cargo, fechanacimiento: @dato.fechanacimiento, nombres: @dato.nombres, rol: @dato.rol } }
    end
  ...
  test "should update dato" do
    patch dato_url(@dato), params: { dato: { apellidos: @dato.apellidos, cargo: @dato.cargo, fechanacimiento: @dato.fechanacimiento, nombres: @dato.nombres, rol: @dato.rol } }
